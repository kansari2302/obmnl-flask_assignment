...
# Search operation with minimum and maximum amount
...
def get_balance():
    ...
    # Render the balance template and pass the total balance to be displayed in transactions.html at bottom as a string in the format Total Balance: {balance}
